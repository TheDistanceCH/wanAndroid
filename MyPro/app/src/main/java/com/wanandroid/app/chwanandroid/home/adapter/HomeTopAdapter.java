package com.wanandroid.app.chwanandroid.home.adapter;
...
public class HomeTopAdapter extends RecyclerView.Adapter<HomeTopAdapter.MyViewHolder> {
    ...
    private List<HomeTopBean.DataBean> datas;
    private OnHomeItemListener listener;

    public HomeTopAdapter(Context context, List<HomeTopBean.DataBean> datas,
                          OnHomeItemListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater
                .from(context)
                .inflate(R.layout.item_top_home, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder,  int i) {
        ...
        if (listener != null) {
            ...
            myViewHolder.imgItemCollectHome.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemCollectImgClick(pos);
                }
            });
        ...
        if (datas.get(pos).getCollect()) {
            Glide.with(context).load(R.drawable.ic_img_collect_sel).into(myViewHolder.imgItemCollectHome);
        } else {
            Glide.with(context).load(R.drawable.ic_img_collect_nor).into(myViewHolder.imgItemCollectHome);
        }
