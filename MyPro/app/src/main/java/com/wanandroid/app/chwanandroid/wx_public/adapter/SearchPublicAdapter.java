 ...
 * function:
 */
public class SearchPublicAdapter extends RecyclerView.Adapter<SearchPublicAdapter.MyViewHolder> {
    ...
    public SearchPublicAdapter(Context context, List<PublicSearchBean.DataBean.DatasBean> datas,
