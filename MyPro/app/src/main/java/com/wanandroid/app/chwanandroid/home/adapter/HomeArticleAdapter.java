 ...
 * function: 设置首页文章列表--非置顶
 */
public class HomeArticleAdapter extends
        RecyclerView.Adapter<HomeArticleAdapter.MyViewHolder> {


    private Context context;
    private List<HomeArticleListBean.DataBean.DatasBean> datas;
    private OnHomeItemListener listener;

    public HomeArticleAdapter(Context context, List<HomeArticleListBean.DataBean.DatasBean> datas,
