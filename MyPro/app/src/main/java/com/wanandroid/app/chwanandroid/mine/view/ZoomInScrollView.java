...
import com.wanandroid.app.chwanandroid.utils.SpringScaleInterpolator;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                try {
                    ...
                    e.printStackTrace();
                    Log.d("chenhua","个人中心的下拉动画出现问题："+e.toString());
                }
                break;
        }
        return super.onTouchEvent(ev);
...
//        设置控件水平居中
     ...
     * 回弹
     */
    private void replyView() throws Exception {
        ...
        anim.setInterpolator(new SpringScaleInterpolator(0.4f));
        anim.start();
...
//        ObjectAnimator objectAnimator =ObjectAnimator.ofFloat(mHeaderView,"translationY",
//                mHeaderHeight,distance);
//        objectAnimator.setDuration(1500);
//        objectAnimator.setInterpolator(new SpringScaleInterpolator(0.4f));
